...
const ThankYou = () => {
  return (
    <main className="min-h-screen bg-hero-gradient text-foreground">
      ...
      <footer className="border-t border-border px-5 py-8 text-center text-sm text-muted-foreground">© {currentYear} Guaranteed CRM by Ar WebCrafts | Email: <a className="text-primary" href={`mailto:${supportEmail}`}>{supportEmail}</a></footer>
    </main>
  );
};
