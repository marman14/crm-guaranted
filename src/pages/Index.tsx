...
const annualPaymentLink = "https://buy.stripe.com/00w3cw2dT0YTek02d19R60t";
const lifetimePaymentLink = "https://buy.stripe.com/dRmcN6f0F6jd5Nu3h59R60u";
const miniAgencyPaymentLink = "https://buy.stripe.com/fZubJ25q56jd6Ry7xl9R60v";
...
const plans = [
  { name: "Solo – Annual", price: "$49 / year", badge: "Best for starters", cta: "Get Annual GHL Account – $49", href: annualPaymentLink, bullets: ["1 full GoHighLevel CRM sub-account for your own business", "All core GHL tools: CRM, funnels, automations, calendars, email/SMS, chat widget", `Email support from Guaranteed CRM (${supportEmail})`, "Upgrade later to Lifetime or Mini Agency by paying only the difference"] },
  { name: "Solo – Lifetime", price: "$99 one-time", badge: "Most popular", cta: "Get Lifetime GHL – $99", href: lifetimePaymentLink, featured: true, bullets: ["Everything in Solo Annual", "Pay once, keep your GoHighLevel account as long as our agency license is active", "No renewals, no surprise price increases"] },
  { name: "Mini Agency – 10 Accounts", price: "$199 / year", badge: "For small agencies", cta: "Get 10 GHL Accounts – $199 / year", href: miniAgencyPaymentLink, bullets: ["Up to 10 GoHighLevel sub-accounts under your name", "Use them for your own brands or resell to clients", "Clone funnels and automations across GHL client accounts", "Priority email support for technical questions"] },
];
  ...
  return (
    <div className="fixed inset-0 z-[60] grid place-items-center bg-background/85 px-5 backdrop-blur-md" role="dialog" aria-modal="true" aria-labelledby="exit-offer-title">
      <div className="relative w-full max-w-lg rounded-2xl border border-primary/40 bg-card-gradient p-6 text-center shadow-glow md:p-8">
        ...
        <Button asChild variant="hero" size="xl" className="mt-5 w-full animate-pulse-glow"><a href={lifetimePaymentLink}>Get LTD Plan – $79 <ArrowRight /></a></Button>
